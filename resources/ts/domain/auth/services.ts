...
/**
 * Provides authentication services, including handling CSRF tokens, user login, and logout operations.
 * All methods return a `Promise` that resolves to a `Result` object indicating success or failure.
 */
