...
/**
 * Represents a functional React component responsible for rendering
 * and handling the login process for user authentication.
 *
 * This component:
 * - Utilizes a form with username and password fields.
 * - Implements validation using a schema to ensure input correctness.
 * - Handles submission, including CSRF token fetching, login request,
 *   error handling, and navigation upon successful authentication.
 * - Manages state for pending submissions and error messages.
 * - Cleans up by aborting any ongoing requests when the component unmounts.
 *
 * Dependencies include React hooks, TanStack Query, form utilities, validation
 * schema libraries, and reusable UI components such as buttons and inputs.
 *
 * The component displays login form elements for user interaction,
 * validations, and feedback messages like errors to improve user experience.
 *
 * @returns {React.ReactNode} The rendered JSX for the login component.
 */
