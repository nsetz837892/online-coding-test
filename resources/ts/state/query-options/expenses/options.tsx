...
/**
 * expenseQueryOptions returns TanStack Query options
 * for the expense domain entities.
 *
 * Requests the API to GET a list of expense entities.
 */
...
/**
 * expenseSummaryQueryOptions returns TanStack Query options
 * for the expense domain summary.
 *
 * Requests the API to GET an expense summary.
 */
